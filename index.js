...
const API_KEY = "e50522bfc8ac4057a95e4539b8860926";
...
function updateHeadline() {
    ...
    const randomIndex = Math.floor(Math.random() * newsDataAr.length);
    const newHeadline = newsDataAr[randomIndex];

    // Update the headline text
    document.getElementById("headline").textContent = newHeadline;
}

// Update the headline every 5 seconds (5000 milliseconds)
